...
router.post('/razorpay', authenticateUser, validateRequest(validators.payment.razorpayment),controllers.Payment.razorpayment);
...
router.post('/cashfree', authenticateUser, validateRequest(validators.payment.cashfreePayment),controllers.Payment.createOrderCashfree);
...
router.get('/status/:orderId', validateRequest(validators.payment.statusCheckCashfree),controllers.Payment.checkStatus);
